...
const TestMarket = () => {
  const { login, user, logout, hasRole } = useAuthStore();
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">
                      {(user.role === 'dt' || (Array.isArray((user as any).roles) && (user as any).roles.includes('dt'))) ? 'Director Técnico' : 
                       (user.role === 'admin' || (Array.isArray((user as any).roles) && (user as any).roles.includes('admin'))) ? 'Administrador' : 'Usuario'}
                      {user.club && ` • ${user.club}`}
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-dark p-6 rounded-lg">
              ...
              <div className="mt-4 pt-4 border-t border-gray-700">
                ...
                <ul className="text-sm space-y-1 text-gray-300">
                  ...
                  <li><span className="text-primary">usuario_dt</span> - Usuario con rol de DT (club: Atlético Pixelado)</li>
        ...
        <div className="card p-6">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-gray-400 text-sm ml-2">
                <li>DT (entrenador): acceso completo al mercado como DT de Neón FC</li>
                <li>DT (usuario_dt): acceso completo al mercado como DT de Atlético Pixelado</li>
