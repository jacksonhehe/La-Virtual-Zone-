          ...
          <div className="bg-dark-light rounded-lg border border-gray-800 p-8">
            <div className="prose prose-invert max-w-none">
              ...
              <ul className="list-disc list-inside text-gray-300 mb-4 ml-6">
                ...
                <li>Posibles secciones de blog, noticias, eventos especiales y otras funcionalidades relacionadas con videojuegos y eSports.</li>
              </ul>
              <p className="text-gray-300 mb-4">
              ...
              <h2 className="text-xl font-bold mt-8 mb-4 text-primary">6. Monedas virtuales, puntos y recompensas</h2>
              <p className="text-gray-300 mb-4">
