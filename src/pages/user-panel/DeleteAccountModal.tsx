...
const DeleteAccountModal = ({
  ...
  }, [closeDeleteModal, isDeletingAccount]);
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      <div
        ...
        className={`relative ${panelSurfaceClass} w-full max-w-lg max-h-[85vh] overflow-hidden border-red-500/35 flex flex-col`}
      >
        <div className="relative bg-gradient-to-r from-red-500/22 via-red-500/12 to-red-500/22 p-5 border-b border-red-500/35">
          ...
          <div className="relative flex items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 id={titleId} className="text-lg sm:text-xl font-bold text-red-200">
                  Eliminar cuenta
                </h3>
                <p className="text-xs sm:text-sm text-gray-200">Esta accion es irreversible.</p>
              </div>
            </div>
            <button
              type="button"
        ...
        <div className="p-5 sm:p-6 space-y-5 overflow-y-auto">
          <p id={descriptionId} className="text-gray-200 text-sm leading-relaxed">
            Esta accion elimina tu cuenta, tu progreso y el contenido asociado de forma permanente.
            <span className="text-white font-semibold"> No podras deshacer este cambio.</span>
          </p>

          <div className="bg-red-500/10 border border-red-500/35 rounded-xl p-5 space-y-3">
            <div className="flex items-center text-sm font-semibold text-red-100">
              <FileWarning size={18} className="mr-2" />
              <span>Se eliminara:</span>
            </div>
            <ul className="text-sm text-red-50/90 list-disc pl-6 space-y-1.5">
              <li>Tu perfil, historial y estadisticas.</li>
              <li>Tu acceso a clubes, equipos y comunidades vinculadas.</li>
              <li>La posibilidad de recuperar esta cuenta mas adelante.</li>
            </ul>
          </div>

          <div className="bg-yellow-500/10 border border-yellow-500/35 rounded-xl p-5">
            <div className="flex items-start gap-3 text-sm text-yellow-100 mb-3">
              <Download size={18} className="mt-0.5 text-yellow-200" />
              <span className="font-semibold">Si lo necesitas, descarga tus datos antes de continuar.</span>
            </div>
            <button
              type="button"
          ...
          <div>
            <label htmlFor="delete-account-confirmation" className="block text-sm font-semibold text-gray-200 mb-2">
          ...
          <label className="flex items-start gap-3 p-4 bg-dark/60 rounded-xl border border-gray-700/60 hover:border-red-500/35 transition-colors cursor-pointer">
            ...
            <span className="text-xs sm:text-sm text-gray-200">
              Entiendo que esta accion es permanente y que mis datos no se podran recuperar.
            </span>
          </label>
