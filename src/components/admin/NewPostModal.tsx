...
import { NEWS_CATEGORIES, getDefaultCategory } from '../../constants/newsCategories';
...
interface NewPostModalProps {
  onClose: () => void;
  onCreate: (data: { title: string; excerpt: string; content: string; image?: string; category: string; author: string; date?: string; tags?: string[] }) => void;
}

const NewPostModal = ({ onClose, onCreate }: NewPostModalProps) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                title="Deja vacío para usar la fecha actual"
              />
              <p className="text-xs text-gray-500 mt-1">Deja vacío para publicar hoy</p>
            </div>
