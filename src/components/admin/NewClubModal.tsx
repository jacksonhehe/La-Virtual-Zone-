...
import { listClubs } from '../../utils/clubService';
...
const NewClubModal = ({ onClose, onCreate, dtUsers }: NewClubModalProps) => {
  ...
  const [fanBase, setFanBase] = useState<number | ''>(10000);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const exists = clubs.some(c => c.name.toLowerCase() === n.toLowerCase());
    if (exists) {
      setError('Ya existe un club con ese nombre');
      return;
    }
    const b = typeof budget === 'string' ? parseInt(budget || '0', 10) : budget;
    if (b !== undefined && (isNaN(b as number) || (b as number) < 0)) {
    ...
    const r = typeof reputation === 'string' ? parseInt(reputation || '50', 10) : reputation;
    if (isNaN(r as number) || (r as number) < 0 || (r as number) > 100) { setError('Reputación debe estar entre 0 y 100'); return; }

    const fb = typeof fanBase === 'string' ? parseInt(fanBase || '10000', 10) : fanBase;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
      ...
      <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden border border-gray-700/50 max-h-[90vh] overflow-y-auto">
        ...
        <div className="relative bg-gradient-to-r from-orange-600/20 via-orange-500/10 to-transparent p-6 border-b border-gray-700/50 sticky top-0 z-10 backdrop-blur-sm">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-2xl font-bold text-white">Nuevo Club</h3>
                <p className="text-sm text-gray-400">Crea un nuevo equipo en la liga</p>
              </div>
            </div>
            <button 
              onClick={onClose} 
        ...
        <div className="p-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 rounded-xl p-5 border border-gray-700/50">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-3">
                    <div className="relative">
                      ...
                      <label
                        ...
                        className="btn-outline w-full flex items-center justify-center cursor-pointer hover:bg-orange-500/10 hover:border-orange-500/50 transition-all"
                      >
                    ...
                    {selectedImage && (
                      <div className="space-y-2 p-3 bg-gray-700/30 rounded-lg border border-gray-600/50">
                        ...
                        <button
                          ...
                          className="btn-primary w-full disabled:opacity-50 disabled:cursor-not-allowed bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700"
                        >
                          {isUploading ? (
                            <>
                ...
                <div>
                  ...
                  />
                  <p className="mt-2 text-xs text-gray-500">El nombre debe ser único en la liga</p>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  >
                    ...
                    {dtUsers.map(u => (
                      <option key={u.id} value={u.id} disabled={!!u.clubId}>
                        {u.username}{u.clubId ? ' (ocupado)' : ''}
                      </option>
                    ))}
                  </select>
            ...
            <div className="flex space-x-3 pt-2">
              ...
              <button 
                type="submit" 
                className="flex-1 btn-primary bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 shadow-lg shadow-orange-500/20 transition-all"
              >
