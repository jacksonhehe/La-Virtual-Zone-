  ...
  players: [
    {
      ...
      peso: 72,
      pierna: 'left',
      estilo_juego: 'Creative Playmaker',
      posicion: 'RWF',
      valoracion: 93,
      precio_compra_libre: 25000000,
      ...
      equilibrio: 95,
      resistencia: 85,
      actitud_defensiva: 35,
      recuperacion_balon: 40,
      agresividad: 45,
      actitud_portero: 10,
      atajar_pt: 10,
      despejar_pt: 10,
      ...
      appearances: 0,
      price: 25000000,
      specialSkills: ['Doble Toque', 'Pase Entre Líneas', 'Centro Exterior'],
      celebrations: ['Individual', 'Gesto']
    },
    {
      id: '2',
      nombre_jugador: 'Karim',
      apellido_jugador: 'Benzema',
      edad: 36,
      altura: 185,
      peso: 81,
      pierna: 'right',
      ...
      equilibrio: 80,
      resistencia: 80,
      actitud_defensiva: 40,
      recuperacion_balon: 45,
      agresividad: 50,
      actitud_portero: 10,
      atajar_pt: 10,
      despejar_pt: 10,
      ...
      appearances: 0,
      price: 20000000,
      specialSkills: ['Juego de Cabeza', 'Finalización Acrobática', 'Tiro de Primera'],
      celebrations: ['Emocionado', 'Correr']
    }
  ],
  matches: [
    {
